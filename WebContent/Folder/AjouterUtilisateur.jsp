		    		 ...
		    		 <label class="control-label" for="inputPassword">Type</label>
			          <div class="controls">
						...
						<select class="form-control" name="type"  >
							 ...
							 <option value="Representation diplomatique étrangère au maroc">Representation diplomatique étrangère au maroc</option>
							 <option value="Representation diplomatique marocaine à l'étrangère">Representation diplomatique marocaine à l'étrangère</option>
